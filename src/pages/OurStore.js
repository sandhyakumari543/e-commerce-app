            ...
            <div className="filter-sort-grid mb-4">
              <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select name="" defaultValue={"manula"}  value={selectedOption}
                    onChange={handleSortChange} className="form-control form-select" id="">
                    ...
                    <option value="created-descending">Date low to high</option>
                  </select>
                </div>
                <div>
                  <div className="d-flex align-items-center-gap-10 ">
