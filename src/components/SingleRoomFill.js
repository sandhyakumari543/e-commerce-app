...
const SingleRoomFill = () => {
    const { addToCart } = useCart();


    const handleAddToCart = () => {
      const product = { image: room, 
    ...
    const props = { width: 400, height: 600, zoomWidth: 600, img: "https://m.media-amazon.com/images/I/71O4cMUuxxL.jpg" };
                ...
                <div className="row">
                    <div className="col-6">
                        ...
                        <div className="other-product-image d-flex flex-wrap gap-15">
                            <div><img src="https://m.media-amazon.com/images/I/71uB9W+RAWL.jpg" alt="watch" className='img-fluid' /></div>
                            <div><img src="https://m.media-amazon.com/images/I/71gGkweoagL.jpg" alt="watch" className='img-fluid' /></div>
                            <div><img src="https://m.media-amazon.com/images/I/81SF00sOB+L.jpg" alt="watch" className='img-fluid' /></div>
                            <div><img src="https://m.media-amazon.com/images/I/71wfTLe+9xL.jpg" alt="watch" className='img-fluid' /></div>
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="main-product-details">
                            <div className='border-bottom'>
                                <h3 className='title'>Mad Man Sound Station Bluetooth Speaker with Wireless Earbuds, Portable Powerhouse Room-Filling Sound, Built-in Earbud Charging Dock, and 25-Hour Battery Life</h3>
                            </div>
                            ...
                            <div className=" py-3">
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className='product-heading'>Type :</h3><p className='product-data'>Room Filling Sound</p>
                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className='product-heading'>Brand :</h3>
                                    <p className='product-data'>Mad Man</p>
                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className='product-heading'>Category :</h3><p className='product-data'>	Electronics</p>
                                </div>
                                <div className='d-flex gap-10 align-items-center my-2'>
                                ...
                                <div className='d-flex gap-10 align-items-center my-2'>
                                    <h3 className='product-heading'>Weight :</h3><p className='product-data'>1</p>
                                </div>
                                ...
                                <div className='d-flex align-items-center gap-15 flex-row mt-2 mb-3'>
                                    ...
                                    <div className='d-flex align-items-center gap-30 ms-5'>
                                        <button onClick={handleAddToCart} className='button border-0' type='submit'>Add to Cart</button>
