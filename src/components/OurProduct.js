    ...
    <>
      ...
      <div className={`${location.pathname == "/product" ? `gr-${grid}` : "col-3"}`}>
        ...
        >
          ...
          <div className="product-image">
            <img src={blue} style={{marginTop:'44px'}} className='img-fluid' alt="product image" />
            <img src={blue2} style={{marginTop:'44px'}}  className='img-fluid' alt="product image" />
          </div>
          <div className="product-details">
            <h6 className='brand'>Havels</h6>
            <h5 className="product-title">
...
<div className={`${location.pathname == "/product" ? `gr-${grid}` : "col-3"}`}>
  ...
  className="product-card position-relative">
    ...
    <div className="product-image">
       <img src={room} style={{marginTop:'44px'}} className='img-fluid' alt="product image" />
            <img src={famous} style={{marginTop:'44px'}}  className='img-fluid' alt="product image" />
    </div>
    <div className="product-details">
      <h6 className='brand'>Havels</h6>
      <h5 className="product-title">
